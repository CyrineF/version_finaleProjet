  ...
  const handleAdd = () => {
    if ((!nom) || (!prénom) || (!email) || (!numero) || (!sexe)) {
      ...
      fetch(`http://localhost:4000/enseignants`, {
        ...
        body: JSON.stringify({ email: email, nom: nom, prénom: prénom, numero: numero, sexe: sexe, mdp: password, spécialités: spécialités }),
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        <DialogContent>
          ...
          <TextField
            ...
            fullWidth
            style={{ width: "40%", margin: "3%" }}
            onChange={(e) => setSpécialités(e.target.value)}
          />
        </DialogContent>
        <div>
